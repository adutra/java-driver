...
object LongCodec extends TypeCodec[Long](DataType.bigint(), new TypeToken[Long]() {}) {
  ...
  override def format(value: Long): String = {
    value.toString
  }
  ...
  override def parse(value: String): Long = {
    try {
      ...
      case e: NumberFormatException =>
        throw new InvalidTypeException( s"""Cannot parse 64-bits long value from "$value"""")
    }
  }
