...
object BigDecimalCodec extends TypeCodec[BigDecimal](DataType.decimal(), new TypeToken[BigDecimal]() {}) {
  ...
  override def format(value: BigDecimal): String = {
  ...
  override def parse(value: String): BigDecimal = {
    try {
      ...
      case e: NumberFormatException =>
        throw new InvalidTypeException( s"""Cannot parse varint value from "$value"""")
    }
  }
